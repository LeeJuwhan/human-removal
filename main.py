...
def main(mask_roi_path, image_roi_path,results_path,mode=None):
    r"""starts the model
    ...
    config = load_config(mask_roi_path, image_roi_path,results_path,mode)
...
def load_config(mask_roi_path, image_roi_path,results_path, mode=None):
    ...
    # test mode
    if mode == 2:
        parser.add_argument('--input', type=str, default = './datasets/test/image_roi/' ,  help='path to the input images directory or an input image')
        parser.add_argument('--mask', type=str, default = './datasets/test/mask_roi/', help='path to the masks directory or a mask file')
